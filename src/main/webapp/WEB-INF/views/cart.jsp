...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.jt.com/"><img clstag="clickcart|keycount|xincart|logo" src="/images/jt-logo.png" title="返回京淘商城首页" alt="返回京淘商城首页"></a></div>
